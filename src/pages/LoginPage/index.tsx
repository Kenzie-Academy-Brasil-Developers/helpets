    ...
    return (
        <>
            <div className="bg-image-main h-screen bg-cover flex justify-center items-center shadow-color-04 relative mobile:flex-col mobile:items-center mobile:pb-[3rem] mobile:h-full">
                ...
                <div className="flex flex-col w-[25.75rem] bg-color-05 border border-[#3AB8C7] rounded-[20px] h-[28.5rem] pt-[2.875rem] pr-[2.875rem] pl-[2.875rem] shadow-[0_0px_32px_1px_#3AB8C7] mobile:pt-[1rem] mobile:pb-[1rem] mobile:w-[18rem] mobile:h-[24rem] mobile:mx-12">
